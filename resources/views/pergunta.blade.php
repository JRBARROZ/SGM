...
<div class="container mt-5 mb-5 p-0">
			...
			<div class="m-4">
				...
				<table class="table mt-4">
					<tbody>
						...
						<tr>
							@else
							<tr style="border: 2px solid #559966">
								@endif
								<td>
									<div class="m-3">
										<div class="row justify-content-between">
											...
											<a href="{{route('resposta-correta',$resposta->id)}}" class="text-primary correta">Correta</a>
											@endif
										</div>
										<br>
	...
	<script type="text/javascript">
		...
		$('.correta').on('click', function(event) {
			...
			$.get($(this).attr('href'), function(data) {
				/*optional stuff to do after success */
				that.parents('tr').css('border', '2px solid #559966');
			});
		});
	</script>
	@endsection
