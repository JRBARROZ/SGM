...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-6 text-center position-relative" style="height: 95%; background-image: url('https://image.freepik.com/fotos-gratis/local-de-trabalho-com-cafe-notebook-smartphone-e-laptop_1112-252.jpg'); background-size: cover;">
			<div class="position-absolute" style="background-color: rgba(0,0,0,0.8); height: 100%; width: 100%; left: 0;">
				<h1 style="margin-top: 35%;">Sistema de Gerenciamento de Monitorias</h1>
				<br>
