  ...
  <div class="grid">
    ...
    <form action="{{ route('login') }}" method="POST" class="form login">
      ...
      <div class="form__field">
        ...
        <input id="login__password" type="password" name="password" class="form-control" placeholder="Senha" required>
      </div>
    ...
    <p class="text--center">Não possui uma conta? <a href="register.blade.php">Cadastre-se</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
